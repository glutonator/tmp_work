...
\newpage
\abstract %//TODO
\input{tex/00a-streszczenie_ang}
 % \kant[1-3]
\keywords irony, NLP, morphosyntactic analysis
...
\input{tex/0-cel_pracy}
\input{tex/1-ironia}
\input{tex/1a-analiza_literatury}
\input{tex/2-embeddings}
\input{tex/3-dane}
\input{tex/4-preprocesing}
\input{tex/4a-warswy}
\input{tex/4b-metryki}
\input{tex/5-eksperymenty}
\input{tex/5b-eksperymenty_dane_opis}
...
\newpage
\appendix
% \appendix{Dodatek A - Wyniki eksperymentów}
\input{tex/5c-eksperymenty_dane_liczbowe}
\input{tex/6-sieci}
