...
Wyniki uzyskane przez modele w ramach tego eksperymentu zostały umieszczone w dodatku \ref{wyniki_eksperymentow_eks_2} w tabelach \ref{tab:wyniki_25_eks2}, \ref{tab:wyniki_300_eks2}, \ref{tab:wyniki_1024_eks2}.
...
Wyniki uzyskane przez modele w ramach tego eksperymentu zostały umieszczone w dodatku \ref{wyniki_eksperymentow_eks_3} w tabelach \ref{tab:wyniki_25_eks3}, \ref{tab:wyniki_300_eks3}, \ref{tab:wyniki_1024_eks3}.
