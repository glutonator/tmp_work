...
\noindent Do najpopularniejszych rodzajów ironii należą\cite{ironia_typy}\cite{ironia_typy2}:
\begin{itemize}
...
\noindent Zjawiskiem często łączącym się z ironią jest sarkazm. Sarkazm jest formą ironii mającej na celu skrytykowanie zaistniałej sytuacji lub obrażenie danej osoby.
\begin{itemize}
